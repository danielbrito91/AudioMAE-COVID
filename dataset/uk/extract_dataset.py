...
# From https://github.com/alan-turing-institute/Turing-RSS-Health-Data-Lab-Biomedical-Acoustic-Markers/blob/main/data-paper/unit_tests.py

def check_audio_properties(row):
    mismatched_files_local = []
    audio_dir = "data/uk/audio" 
...
class TestAudioFiles(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.audio_metadata = pd.read_csv('data/uk/audio_metadata.csv')
